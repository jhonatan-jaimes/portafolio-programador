...
export const FooterComponent = () => {
    return (
        <footer className={styles.contain} id='contacto'>
            <div className={styles.contDiv}>
                ...
                <div>
                    ...
                    <div className={styles.contactIt}>
                        <p>GitHub: </p>
                        <Link to={"https://github.com/jhonatan-jaimes"} target="_blank" className={styles.link}>
                                https://github.com/jhonatan-jaimes
                        </Link> 
                     </div>
                    <div className={styles.contactIt}>
                        <p>LinkedIn: </p>
